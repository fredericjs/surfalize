...
def thumbnail(input_file: Path, output_file: Path, size: int):
    """
    Generate a PNG thumbnail (used by desktop environments).
    """
    try:
        ...
        # --- Render exactly at requested thumbnail size ---
        dpi = 72
        fig_size = size / dpi
        ...
        # GNOME requires silence on failure
        raise SystemExit(1)
